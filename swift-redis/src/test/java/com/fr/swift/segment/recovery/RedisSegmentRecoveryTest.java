...
@PrepareForTest({SwiftContext.class, AbstractSegmentRecovery.class, RedisSegmentRecovery.class, SwiftEventDispatcher.class, SwiftInserter.class})
public class RedisSegmentRecoveryTest {
    ...
    public void recover() throws Exception {
        ...
        RedisSegmentRecovery recovery = spy(new RedisSegmentRecovery());
        ...
        RedisBackupResultSet resultSet = mock(RedisBackupResultSet.class);
        whenNew(RedisBackupResultSet.class).withArguments(backupSeg).thenReturn(resultSet);
